...
{
    public class DbUserMasterConnectcs
    {

        SqlConnection con = null;
        SqlCommand cmd = null;

        public DbUserMasterConnectcs()
        {
        ...
        public List<Records> GetUserData(string OrderBy, string WhereClause)
        {
        ...
        public int UpdateUserStatus(Records U)
        {
            if (U.Id != 0)
            {
                using (con)
